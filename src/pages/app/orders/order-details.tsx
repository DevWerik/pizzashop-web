...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: iuqe98eqr3o8eruq</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">João da Silva</TableCell>
            </TableRow>
          ...
          <TableHeader>
            ...
            <TableFooter>
                <TableRow>
                    ...
                    <TableCell className="text-right font-medium">R$ 219,40</TableCell>
                </TableRow>
            </TableFooter>
        </Table>
      </div>
